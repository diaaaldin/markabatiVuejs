...
export default {
    ...
    methods: {
        ...
        mapData(){
                ...
                this.data.id= this.getVehicleData.id;
                this.data.brandIdFk= this.getVehicleData.brandIdFk;
                this.setBrandModels();
                this.data.modelIdFk= this.getVehicleData.modelIdFk;
                this.data.year= this.getVehicleData.year;
                this.data.numOfMeals= this.getVehicleData.numOfMeals;
                this.data.bodyTypeIdCfk=this.getVehicleData.bodyTypeIdCfk;
                this.data.colorIdCFK= this.getVehicleData.colorIdCFK;
                this.data.paintedTypeIdCfk= this.getVehicleData.paintedTypeIdCfk;
                this.data.paintedStatusIdCfk= this.getVehicleData.paintedStatusIdCfk;
                this.data.specificationIdCfk= this.getVehicleData.specificationIdCfk;
                this.data.price= this.getVehicleData.price;
                this.data.currency= this.getVehicleData.currency;
                this.data.gearTypeIdCfk= this.getVehicleData.gearTypeIdCfk;
                this.data.oilTypeIdCfk= this.getVehicleData.oilTypeIdCfk;
                this.data.moreInfo= this.getVehicleData.moreInfo;
                this.data.bestThreeCategories= this.getVehicleData.bestThreeCategories;
                this.data.extinsionCategory = this.getVehicleData.extinsionCategory;
            ...
            try {
                ...
                if (this.checkUpdateValidation()) {
                    this.UpdateVehicle(this.data).then((Response) => {
                        this.$moshaToast('تمت عملية الحفظ بنجاح', {
                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        <div v-for="(category, index) in data.bestThreeCategories" :key="index" class="col-12 col-sm-4">
                            <div class="form-group">
                                <input v-model="data.bestThreeCategories[index]"  :placeholder="`المميزة ` + (index + 1)" type="text" class="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="box-addition  px-3 mb-3 ">
                        ...
                        <div class="form-group add_addition">
                            <button id="add" type="button" class="btn btn-primary" v-on:click="addAddition()">اضافة <i class="fa fa-solid fa-plus"></i></button>
                        </div>
                    </div>
                </div>
            </div>
