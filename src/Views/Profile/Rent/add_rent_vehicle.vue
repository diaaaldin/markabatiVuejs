...
export default {
	...
	methods: {
		...
		...mapActions("Vehicles", ["CreateRentVehicle"]),
		...
		createFunc() {
			...
			this.CreateRentVehicle(payload)
				.then((Response) => {
	...
	<div class="col-12 col-lg-9 add_vehicle">
		<div class="container white_card px-4 pt-4 pb-0 mt-3 mt-lg-0 right-side">
			...
			<div class="page-header">
				<div class="row">
					<div class="col-sm-12">
						<h3 class="page-title">إضافة مركبة للإيجار</h3>
					</div>
				</div>
			</div>
				...
				<div class="row form-row justify-content-center">
					...
					<div class="col-12">
						<BorderBox title="سعر الإجار والعملة" variant="rent">
							<div class="form-group">
								<label class="price-privacy-toggle" for="rentPriceHiddenAdd">
									<input id="rentPriceHiddenAdd" v-model="data.isHiddenPrice"
									...
									<div class="col-12 col-md-6">
										<div class="form-group">
											...
											<input v-model="data.price" type="number"
												placeholder="أدخل سعر الإجار اليومي (مثال: 250)" min="0" step="0.01"
