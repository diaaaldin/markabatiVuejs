...
export default {
    ...
    methods: {
        ...mapActions("Users", ["GetVehicleRentelers"]),
        ...
        initFunc() {
            ...
            this.GetVehicleRentelers(this.dataSearch).then(Response => {
                    ...
                    <div class="col-12">
                        <div class="container white_card mt-2">
                            ...
                            <div v-else class="row">
                                <sellerCard v-for="item in usersList" :key="item.id" :seller='item' galleryRouteName="rent_gallary"></sellerCard>
                            </div>
