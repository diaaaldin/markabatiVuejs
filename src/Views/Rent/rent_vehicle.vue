...
import rentVehicleSemilerCard from '@/components/Cards/rentVehicleSemilerCard.vue'
...
export default {
    ...
    methods: {
        ...mapActions("Vehicles", ["GetRentVehicle", "ToggleVehicleFavorite", "GetVehiclesFavoriteId"]),
        ...
        initFunc() {
            ...
            this.GetRentVehicle(id).then(Response => {
        ...
        toSellerGallaryFunc() {
            this.$router.push({ name: "rent_gallary", params: { slug: this.data.ownerSlug } });
        ...
        <nav>
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <router-link to="/rent_vehicles" :class="{ active: $route.path === '/rent_vehicles' }"> {{
                            $t('location_menu_rent_vehicles') }} </router-link>
                    </li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 text-center">
                    <div class="details-squre">
                        ...
                        <h5>{{ $t('vehicle_card_rent_price') }}</h5>
                        <p v-if="!isHiddenPrice" class="rent-price-value">
                            {{ formatCurrency(data.price, data.currency) }}
                        </p>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="same-vehicle">
                        ...
                        <div class="row">
                            <rentVehicleSemilerCard v-for="item in data.cardOfVehicle" :product='item'></rentVehicleSemilerCard>
                        </div>
                    </div>
                </div>
            </div>
