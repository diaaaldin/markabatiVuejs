...
import rentVehicleCard from '@/components/Cards/rentVehicleCard.vue';
...
export default {
    ...
    methods: {
        ...
        ...mapActions("Vehicles", ["GetRentVehiclesRandomly"]),
        ...
        handleFilterChange({ stateId, vehicleBrandId, vehicleModelId, yearFrom, yearTo, priceFrom, priceTo, color, bodyType, specification, paintedType, paintedStatus, gearType, oilType }) {
        ...
        <nav>
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $t('location_menu_rent_vehicles') }}</li>
                </ol>
    ...
    <section class="profile vehicles mt-5">
        <div class="container">
            <div class="row mt-5 h-100">
                ...
                <Filter :showMealsFilter="false" @filterChange="handleFilterChange"></Filter>
                <!-- end left side list-->
                ...
                <div class="col-12 col-lg-9 ">
                    ...
                    <div v-else class="container white_card mt-2 right-side">
                        <span class="header-title"> {{ $t('rent_vehicles_title') }} </span>
                        ...
                        <div class="row">
                            <rentVehicleCard v-for="item in vehiclesList" :key="item.id" :product='item'>
                            </rentVehicleCard>
                        </div>
                        <!-- <div class="row">
                            <div class="pag">
