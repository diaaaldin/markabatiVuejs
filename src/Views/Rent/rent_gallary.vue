...
export default {
	...
	methods: {
		...
		...mapActions("Vehicles", ["GetUserRentVehicles"]),
		...
		initFunc() {
			...
			this.GetUserRentVehicles(this.dataSearch).then(Response => {
			...
			<div class="row">
				<div class="container white_card mt-2">
					...
					<div v-else class="row">
						<rentVehicleCard v-for="item in vehiclesList" :key="item.id" :product='item'></rentVehicleCard>
					</div>
					<!-- <div class="row">
						<div class="pag">
