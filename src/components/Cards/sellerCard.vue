        ...
        seller: {
            ...
            default() {
                return {
                     id: 0,
                    ownerId: 0,
                    onerName: "عبد الله المدهون",
                    city: "قطاع غزة" ,
                    state: "تل الهوا",
                    addres: "شارع الجلاء - بالقرب من  الزهارنة",
                    ownerImage: "",
                    ownerMobile: "",
                    brandId: 0,
                    brandName: "فيراري",
...
<template>
  						<div class="col-12 col-lg-3 col-md-6 mt-4 text-center">
                                <div class="card seller_card">
                                    <div class="img">
                                        <img  :src="seller.image" class="" alt="...">
                                    </div>
                                    <div class="card-body ">
                                        <div class="d-flex justify-content-center align-items-baseline mb-2">
                                            <h6 class="card-title justify-content-center">{{ seller.onerName }}</h6>
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <div class=" d-flex  flex-column">
                                                <div class="d-flex align-items-center mb-2">
													<ul class="addresul">
														<li>{{ seller.city }} / {{ seller.state }} </li>
														<li>{{ seller.addres }} </li>
													</ul>
                                                </div>
                                                ...
                                                <div class=" d-flex align-items-center ">
                                                    <a  @click="$router.push({ name: 'gallary' })" class="btn btn-light p-3 contact-with-seller w-100">زيارة المعرض</a>
                                                </div>
