...
var l = (e2, t2) => {
  for (var o2 in t2 || (t2 = {})) s.call(t2, o2) && r(e2, o2, t2[o2]);
  if (n) for (var o2 of n(t2)) i.call(t2, o2) && r(e2, o2, t2[o2]);
  return e2;
};
...
var te = (e2, t2) => {
  ...
  if (e2.__v_isVNode) return oe(o2, M.VNODE, n2, e2), { close: () => le(o2, n2.position) };
  if (e2.hasOwnProperty("render")) return oe(o2, M.COMPONENT, n2, e2), { close: () => le(o2, n2.position) };
  const s2 = ie(e2);
...
var re = (e2, t2, o2) => {
  let n2 = o2;
  if (!e2.position) throw new Error("no position");
